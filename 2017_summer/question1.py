...
def solution(n):
    ans = 0
    #     possible_dict = {1: 1, 2: 1}

    #     if n == 1 or n == 2:
    #         return possible_dict[n]

    #     for case in range(3, n+1):
    #         if case % 2 == 1:
    #             possible_dict[case] = possible_dict[case - 1] + 1
    #         else:
    #             possible_dict[case] = possible_dict[case // 2]

    #     # print("possible_dict: " , possible_dict)
    #     return possible_dict[n]
    while n > 0:
        if n % 2 == 1:
            ans += 1
